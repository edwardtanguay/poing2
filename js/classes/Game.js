...
export default class Game {
	...
	pointsPlayer1 = 0; // TODO: put in Player class
	pointsPlayer2 = 0;
	...
	updateData() {
		...
		if (this.player1.position.y < 50) {
			...
			this.player1.position.y + this.player1.size.height >
			this.canvas.height
		) {
			this.player1.position.y =
				this.canvas.height - this.player1.size.height;
		}

		if (this.player1.position.x < 10) {
			this.player1.position.x = 10;
		} else if (
			this.player1.position.x + this.player1.size.width >
			this.canvas.width / 2
		) {
			this.player1.position.x =
				this.canvas.width / 2 - this.player1.size.width;
		}
		...
		if (this.player2.position.y < 50) {
			...
			this.player2.position.y + this.player2.size.height >
			this.canvas.height
		) {
			this.player2.position.y =
				this.canvas.height - this.player2.size.height;
		}

		if (this.player2.position.x < 300) {
			this.player2.position.x = 300;
		} else if (
			this.player2.position.x + this.player2.size.width >
			this.canvas.width
		) {
			this.player2.position.x =
				this.canvas.width - this.player2.size.width;
		}
		...
		if (this.ball.position.y < 90) {
			...
			this.ball.position.y + this.ball.size.height >
			this.canvas.height
		) {
		...
		if (!Keyboard.arrowLeft.isPressed && !Keyboard.arrowRight.isPressed) {
			...
			Keyboard.arrowLeft.isPressed &&
			Keyboard.arrowRight.isPressed
		) {
			this.player2.velocity.x = 0;
	...
	draw() {
		...
		this.context.fillText(
			`${this.pointsPlayer1} : ${this.pointsPlayer2}`,
